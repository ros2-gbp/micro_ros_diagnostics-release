...
Name:           ros-galactic-micro-ros-diagnostic-msgs
Version:        0.2.0
Release:        4%{?dist}%{?release_suffix}
Summary:        ROS micro_ros_diagnostic_msgs package
...
%description
A package containing diagnostics related messages and service definitions for
micro-ROS.
