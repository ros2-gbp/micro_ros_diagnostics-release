...
%global pkg_name micro_ros_diagnostic_bridge
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-micro-ros-diagnostic-bridge
Version:        0.3.0
Release:        7%{?dist}
...
%changelog
* Wed Apr 29 2026 Bartolome Jimenez Vera <bjv@capra.ooo> - 0.3.0-7
- Autogenerated by Bloom

* Tue Apr 28 2026 Bartolome Jimenez Vera <bjv@capra.ooo> - 0.3.0-6
- Autogenerated by Bloom

* Tue Apr 21 2026 Bartolome Jimenez Vera <bjv@capra.ooo> - 0.3.0-5
- Autogenerated by Bloom
